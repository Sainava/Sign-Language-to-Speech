...
class SignLanguageModel(nn.Module):
    def __init__(self, pose_dim=4, face_dim=3, hand_dim=3,
        ...
        self.pose_branch = LandmarkBranch(pose_dim, cnn_out, lstm_hidden, bidirectional=bidirectional)
        self.face_branch = LandmarkBranch(face_dim, cnn_out, lstm_hidden, bidirectional=bidirectional)
        self.lhand_branch = LandmarkBranch(hand_dim, cnn_out, lstm_hidden, bidirectional=bidirectional)
        self.rhand_branch = LandmarkBranch(hand_dim, cnn_out, lstm_hidden, bidirectional=bidirectional)
